...
class FilaSequencial:
    ...
    def __init__(self):
        self.fila = []
        #Define o tamanho máximo da fila (5 no caso)
    ...
    def consulta_primeiro(self):
        #Verifica se a fila está vazia, retorna None se está
        if FilaSequencial.fila_vazia(self):
            return None
        else:
            return self.fila[0]
...
class InterfaceGrafica:
    ...
    def __init__(self, master):
        ...
        self.label = Label(master, text="Fila Sequencial")
        self.label.pack()
        ...
        self.label_remover = Label(master, text="Remover 1º valor")
        ...
        self.label_consulta_primeiro = Label(master, text="Consultar 1º valor")
    ...
    def atualizar_listbox(self):
        ...
        for i in range(len(self.fila_sequencial.fila)):
            caixa = Label(self.frame_fila, text=self.fila_sequencial.fila[i], width=5, borderwidth=1, relief="solid")
